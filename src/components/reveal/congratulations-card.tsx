...
const CongratulationsCard = () => {
  ...
  return (
    <div className="relative z-40 h-full w-full bg-[#9286C5]/80">
      ...
      <div className="relative z-20 h-full">
        ...
        <div className="container mx-auto flex h-full w-full flex-col items-center justify-between p-6 md:flex-row xl:p-10">
          ...
          <div className="flex flex-1 items-end justify-end gap-8">
            {/* Coupon card area mobile*/}
            <div className="relative my-8 block w-72 md:hidden">
              <Image
              ...
              <div className="absolute -bottom-5 left-1/2 flex -translate-x-1/2 gap-4 md:hidden">
                {/* Copy button */}
                <button
                  aria-label="Copy coupon code"
                  onClick={handleCopy}
                  className="grid size-11 place-items-center rounded-full border border-[#CFC8F7] bg-[#4C12A1] transition-all active:scale-95"
                >
            ...
            {/* Coupon card area desktop*/}
            <div className="relative hidden w-75 md:block lg:w-95 xl:w-130">
              <Image
              ...
              <div className="absolute top-1/2 right-[5%] -translate-y-1/2">
                ...
                <p className="font-currys text-center text-xs font-semibold text-black uppercase lg:text-base xl:text-lg">
                  {COUPON_CODE}
                </p>
              </div>
            ...
            <div className="hidden flex-col gap-4 md:flex">
              ...
              <button
                aria-label="Copy coupon code"
                onClick={handleCopy}
                className="grid size-8 place-items-center rounded-full bg-[#FFECB7] transition-all hover:bg-[#FFECB7]/80 active:scale-95 lg:size-10"
              >
                {/* existing clipboard SVG */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                aria-label="Download image (coming soon)"
                className="grid size-8 place-items-center rounded-full bg-[#FFECB7] text-[#213038] transition-all hover:bg-[#FFECB7]/80 active:scale-95 lg:size-10"
                title="Coming soon"
              >
                {/* your download SVG */}
                <svg
