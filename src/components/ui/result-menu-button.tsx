...
export default function MenuButton() {
  ...
  const handleReport = () => {
    window.open("https://the-currys.net/contact-us", "_blank");
    setIsOpen(false);
  };
  ...
  const menuItems = [
    ...
    { icon: LogOut, label: "Exit", onClick: handleExitClick  },
  ];
          ...
          {isOpen && (
            <>
              ...
              <motion.div
                ...
                className="absolute top-full right-0 z-50 mt-2 w-35 overflow-hidden rounded-[20px] border border-white/20 shadow-lg md:w-40 lg:w-[180px]"
                style={{
